...
its quarter-turn rotation symmetry used by the Python reference model. It does
not yet formalize the finite P104 witness, the one-black prefix, or the global
Highway Conjecture.
